...
namespace TetrisConsole
{
    class LLTetra : ITetramino
    {
        ...
        public LLTetra(int[] coords)
        {            
            this.coords = new int[4][];
            this.coords[0] = coords;                                                    //1            1  
            this.coords[1] = new int[] { coords[0], coords[1] + 1 };                    //2            234
            this.coords[2] = new int[] { coords[0] + 1, coords[1] + 1 };                //3
            this.coords[3] = new int[] { coords[0] + 2, coords[1] + 1 };                //4
        ...
        public void Rotate()
        {
            switch (rotationState)
            {
                case 0:
                    rotationState = 1;
                    coords[0] = new int[] { coords[0][0] + 2, coords[0][1] };
                    coords[1] = new int[] { coords[1][0] + 1, coords[1][1] - 1 };
                    coords[2] = new int[] { coords[2][0], coords[2][1] };
                    coords[3] = new int[] { coords[3][0] - 1, coords[3][1] + 1 };
                    break;
                case 1:
                    rotationState = 2;
                    coords[0] = new int[] { coords[0][0], coords[0][1] + 2 };
                    coords[1] = new int[] { coords[1][0] + 1, coords[1][1] + 1 };
                    coords[2] = new int[] { coords[2][0], coords[2][1] };
                    coords[3] = new int[] { coords[3][0] - 1, coords[3][1] - 1 };
                    if (Collision(coords))
